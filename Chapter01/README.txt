...
3. Modify the temperature conversion program to print a heading
   above the table.

4. Write a program to print the corresponding Celsius to Fahrenheit
   table.

5. Modify the temperature conversion program to print the table in
...
9. Write a program to copy its input to its output, replacing each
   string of one or more blanks by a single blank.

10. Write a program to copy its input to its output, replacing each
    tab by \t, each newline by \n, and each backslash by \\. This 
